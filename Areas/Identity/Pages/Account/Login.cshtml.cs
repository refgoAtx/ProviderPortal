...
namespace Provider.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
		...
		public LoginModel(SignInManager<ProviderUser> signInManager, ILogger<LoginModel> logger, Provider.Data.ProviderContext context)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
					var Userhostip = HttpContext.Connection.RemoteIpAddress?.ToString();

					if (_context.Users.Any(x => x.Ip == Userhostip))
                    {
                ...
                if (result.RequiresTwoFactor)
                {
                    ...
                    if (_context.Users.Any(x => x.Ip == ip))
                    {
